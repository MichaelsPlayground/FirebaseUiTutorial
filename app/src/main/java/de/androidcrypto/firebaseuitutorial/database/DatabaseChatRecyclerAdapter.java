...
public class DatabaseChatRecyclerAdapter extends FirebaseRecyclerAdapter<MessageModel, DatabaseChatRecyclerAdapter.ModelViewHolder> {

    Context context;

    public DatabaseChatRecyclerAdapter(@NonNull FirebaseRecyclerOptions<MessageModel> options, Context context) {
        super(options);
