...
public class DatabaseEditUserProfileLegacyActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks,
    ...
    private void saveBitmapFileToIntermediate(Uri sourceUri) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N)
                intermediateProvider = FileProvider.getUriForFile(DatabaseEditUserProfileLegacyActivity.this, FILE_PROVIDER_AUTHORITY + ".provider", imageFile);
            else
    ...
    private void onCropImage() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            if (size == 0) {
                ...
                resultProvider = FileProvider.getUriForFile(DatabaseEditUserProfileLegacyActivity.this, FILE_PROVIDER_AUTHORITY + ".provider", photoFile);
